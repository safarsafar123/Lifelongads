...
const Contact = () => {
  ...
  const sendEmail = (e: React.FormEvent) => {
    ...
    emailjs
      .sendForm(
        "service_3tvvjcg", // your service ID
        "template_aqrovce", // your template ID
        formRef.current,
        "_5sqRHRNsDljay467", // your public key
      )
      .then(() => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <FadeIn>
              ...
              <p className="text-xl text-neutral-gray font-light leading-relaxed mb-12">
                Whether you need cinematic brand storytelling, identity design,
                or performance-driven media strategy, Lifelong Ads is ready to
              ...
              <div className="space-y-8 mb-12">
                <div className="flex gap-6 items-start">
                  ...
                  <div>
                    <h4 className="text-xs font-bold uppercase tracking-widest text-primary/40 mb-1">
                      Email Us
                    </h4>
                    <a
                ...
                {[
                  {
                    ...
                    url: "https://www.instagram.com/lifelongads.media",
                  },
                  {
                    icon: <Facebook size={20} />,
                    url: "https://www.facebook.com/share/1CX8qbEmqT/?mibextid=wwXIfr",
                  },
                  {
                    icon: <Linkedin size={20} />,
                    url: "https://www.linkedin.com/company/lifelongads/",
                  },
                  {
                    icon: <MessageCircle size={20} />,
                    url: "https://wa.me/971547798628",
                  },
                ].map((social, i) => (
                  <a
                    key={i}
            ...
            <FadeIn
              delay={0.2}
              className="bg-secondary p-10 md:p-16 border border-accent/10 rounded-sm shadow-xl"
            >
              <form ref={formRef} className="space-y-6" onSubmit={sendEmail}>
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    required
                    defaultValue=""
                    className="w-full bg-transparent border-b border-accent/20 py-3 focus:border-accent outline-none transition-colors appearance-none"
                  >
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    name="message"
                    rows={4}
                    className="w-full bg-transparent border-b border-accent/20 py-3 focus:border-accent outline-none transition-colors resize-none"
